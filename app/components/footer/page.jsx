      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-2xl sm:text-3xl font-bold mb-4 text-blue-400">AutoKenya</h3>
          ...
          {/* Contact & Locations */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-white">Contact & Locations</h4>
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center mb-3 text-gray-300">
                ...
                <div>
                  <div className="font-medium">info@autokenya.com</div>
            ...
            {/* Locations */}
            <div>
              <h5 className="font-semibold mb-2 text-gray-200">We Cover:</h5>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-300">Get the latest car deals and offers in Central Kenya</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
              <input 
                type="email" 
                placeholder="Enter your email"
                className="px-4 py-3 rounded-lg bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 flex-1 min-w-0"
              />
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-gray-300 text-sm text-center md:text-left">
              <p>&copy; 2024 AutoKenya. All rights reserved. | Your Trusted Car Marketplace in Central Kenya</p>
            </div>

...
// Mock data for car sell inquiries from users
const mockSellInquiries = [
  ...
  },
  {
    ...
    transmission: "Automatic",
    fuelType: "Diesel",
    features: ["4WD", "Roof Rails", "Parking Sensors", "LED Lights", "Leather Seats"],
    description: "Powerful Mazda CX-5 with diesel engine. Great for both city and off-road driving. Well maintained with service history. No major accidents, minor scratches on bumper.",
    sellerName: "Mike Otieno",
    sellerPhone: "+254734567890",
    sellerEmail: "mike.otieno@example.com",
    images: [
      "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=500&h=350&fit=crop"
    ],
    status: "published",
    submittedAt: "2024-01-15T08:45:00Z",
    approvedAt: "2024-01-16T11:20:00Z",
    reviewedBy: "Admin User",
    notes: "Excellent condition, ready for publishing. Good photos.",
    priority: "high"
  },
  {
    id: 4,
    reference: "CAR004",
    carName: "Toyota Hilux 2022",
    year: "2022",
    price: "3,500,000",
    location: "Thika",
    carType: "Pickup",
    ...
    description: "Brand new Toyota Hilux with warranty. Perfect for business and personal use. Double cab with excellent towing capacity. Still under manufacturer warranty.",
    sellerName: "David Mwangi",
    sellerPhone: "+254745678901",
    sellerEmail: "david.mwangi@example.com",
    images: [
    ...
    approvedAt: null,
    reviewedBy: "Admin User",
    notes: "Price seems too low for this model. Suspect possible scam. Need to verify documents.",
    priority: "high"
  },
  {
    id: 5,
    reference: "CAR005",
    carName: "Mercedes C-Class 2021",
    year: "2021",
    price: "4,200,000",
    location: "Nairobi",
    carType: "Luxury",
    ...
    transmission: "Automatic",
    fuelType: "Petrol",
    features: ["Leather", "Panoramic Roof", "Premium Sound", "Navigation", "Heated Seats"],
    description: "Luxury Mercedes C-Class with all premium features. Imported from UK. Full service history and excellent condition. All original features working perfectly.",
    sellerName: "Sarah Chemutai",
    sellerPhone: "+254756789012",
    sellerEmail: "sarah.chemutai@example.com",
    images: [
...
export default function CarSellInquiries() {

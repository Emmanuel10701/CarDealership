...
import { FaCar, FaMapMarkerAlt, FaCog, FaGasPump, FaBuilding, FaPhone, FaTimes, FaCalendar, FaTachometerAlt, FaShieldAlt, FaStar } from 'react-icons/fa'
import { IoMdSpeedometer } from 'react-icons/io'
import Filter from '../filer/page'
    ...
    <section id="cars" className="min-h-screen bg-gray-50 py-4">
      <div className="w-full px-2 sm:px-4">
        ...
        <div className="text-center mb-6">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2">Quality Used Cars</h2>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                <div className="flex items-center gap-4">
                  <p className="text-gray-600 text-sm">
                    Showing <span className="font-semibold">{currentCars.length}</span> of{' '}
                    <span className="font-semibold">{filteredCars.length}</span> cars
                  </p>
                </div>
                ...
                <div key={car.id} className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden group">
                  <div className="relative">
                    ...
                    <div className="absolute top-3 left-3 flex gap-2">
                      <span className="bg-blue-600 text-white px-2 py-1 rounded-full text-xs font-semibold flex items-center gap-1">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex gap-2">
                      <button 
                        ...
                        className="flex-1 bg-blue-600 text-white py-3 px-4 rounded-xl hover:bg-blue-700 transition duration-300 font-semibold text-sm flex items-center justify-center gap-2"
                      >
                        <FaCar />
                        View Details
                      </button>

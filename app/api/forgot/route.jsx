...
export async function POST(req) {
  try {
    ...
    await transporter.sendMail({
      from: {
        name: 'CorporateSellers Support',
        address: process.env.EMAIL_USER
      },
      to: email,
      subject: 'Password Reset Request - CorporateSellers',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
          ...
          <title>Password Reset - CorporateSellers</title>
          <style>
            body {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>We received a request to reset the password for your CorporateSellers account associated with <strong>${email}</strong>.</p>
  ...
  >
    🔑 Reset Your Password
              ...
              <p>Best regards,<br>
              <strong>The CorporateSellers Team</strong></p>
            </div>
            
            <div class="footer">
              <p>© ${new Date().getFullYear()} CorporateSellers. All rights reserved.</p>

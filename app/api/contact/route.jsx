...
// Define the new dealer name as a constant for easy maintenance
...
              <p style="color: rgba(255, 255, 255, 0.8); font-size: 16px; margin: 8px 0 0;">${DEALER_NAME} Website</p>
            </div>
...
      from: emailUser,
      to: email,
      // Updated subject line to reflect the new dealer name
...
                                <p style="color: #718096; font-size: 16px; line-height: 1.6; margin: 0;">We've received your message and our team will get back to you **as soon as possible**.</p>
              </div>
...
    return NextResponse.json({ 
      success: true,
      // Updated success message for the user
